...
import { ChevronDown, ChevronRight, Settings2, Music, BarChart3 } from 'lucide-react';
  ...
  return (
    <div className="sidebar-section settings-panel">
      ...
      <SectionHeader
        icon={Settings2}
        title="Spectrogram"
        expanded={!!expandedSections.spectrogram}
        onToggle={() => toggle('spectrogram')}
      />
      {expandedSections.spectrogram && (
      ...
      <SectionHeader
        icon={BarChart3}
        title="Formant"
        expanded={!!expandedSections.formant}
        onToggle={() => toggle('formant')}
      />
      {expandedSections.formant && (
        <div className="settings-grid">
          <label className="settings-field">
